...
product_model = product_endpoints.model('Product', {
    ...
    'priceText': fields.String(required=True, description='Preço do produto formatado em reais', example='R$ 1,50', attribute='price_text'),
...
class ProductList(Resource):
    def __init__(self, *args, **kwargs):
        self.__services = CatalogServices.get_product_services()
